...
{
    /* This is mercator-based. 
     * I think It's not essencial to use this-way.
     * I think it's OK just set X=longitude, Y=latitude.
     * So I don't use this script.
     */
    private static readonly double R_MAJOR = 6378137.0;//earth r [m]
    private static readonly double R_MINOR = 6356752.3142;//earth r [m]
    ...
    private static double DegToRad(double deg)//degree to radian
    {
        return deg * DEG2RAD;
    }
}